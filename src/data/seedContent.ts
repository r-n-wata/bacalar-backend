...
export const toursContentByLanguage: Record<AppLanguage, ToursContent> = {
  en: {
    ...
    description: 'Browse lagoon outings, water activities, and local adventures by tour.',
    categories: ['Sailing', 'Boat Tour', 'Kayak Tour'],
    featuredItems: [
      {
        id: 'tour-sailing',
  ...
  es: {
    ...
    description: 'Explora actividades, aventuras y salidas en la laguna por tour.',
    categories: ['Sailing', 'Boat Tour', 'Kayak Tour'],
    featuredItems: [
      {
        id: 'tour-sailing',
...
> = {
  en: {
    ...
    'tour-kayak': {
      ...
      description:
        'A lighter, more active outing through calmer edges of the lagoon for travelers who want a nature-forward tour without committing a full day.',
      imageUrls: [],
      operatorName: 'Manglar Guides',
